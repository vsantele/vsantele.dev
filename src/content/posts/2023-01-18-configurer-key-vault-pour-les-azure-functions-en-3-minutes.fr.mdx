...
<Figure src="/img/2023/01/Azure-Functions-KeyVault-Corgi.webp" />
...
<Figure src="/img/2023/01/Create-Azure-Keyvault.png" caption="Création d'un Azure Key Vault via le Portail" />
...
<Figure src="/img/2023/01/Azure-Keyvault-Access-Policy.png" caption="Ajout d'une politique d'accès au Key Vault" />
...
<Notice type="tip" title="Via le CLI">
...
<Figure src="/img/2023/01/Azure-Function-Add-Identity.png" caption="Ajout d'une identité à une Azure Function" alt="Création de l'identité pour la Function App depuis le portail" />
...
<Figure src="/img/2023/01/Azure-Keyault-Add-Identity.png" caption="Ajout de l'identité" alt="Ajout de l'identité via le portail en sélectionnant les accès" />
...
<Figure src="/img/2023/01/Azure-Keyvault-Create-Secret.png" caption="Création du secret" alt="Création du secret dans Azure Keyvault via le portail" />
