...
<Figure src="/img/2022/12/Azure-Functions-Vscode-Corgi.webp" />
...
<Notice type="example" title="Exemple">
...
- Cassandra : [learn.microsoft.com/en-us/azure/cosmos-db/local-emulator#api-for-cassandra](https://learn.microsoft.com/en-us/azure/cosmos-db/local-emulator#api-for-cassandra)
- Gremlin : [learn.microsoft.com/en-us/azure/cosmos-db/local-emulator#api-for-gremlin](https://learn.microsoft.com/en-us/azure/cosmos-db/local-emulator#api-for-gremlin) 
